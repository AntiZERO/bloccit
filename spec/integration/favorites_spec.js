// define the dependencies for the integration tests
...
describe("routes : favorites", () => {
  ...
  beforeEach((done) => {
    ...
    // define the variables to be used for the tests
    this.user;
    this.topic;
    this.post;
    this.favorite;

    // clear the data, and then create the objects for the tests. 
  ...
  // define test suite for a quest attempting to favorite a post
  describe("guest attempting to favorite on a post", () => {
    ...
    describe("POST /topics/:topicId/posts/:postId/favorites/create", () => {
      ...
      it("should not create a new favorite", (done) => {
        ...
        // take note of the number of favorites that exist for the post before
        // sending the delete request. We then check that the number of favorites
        // has not changes to confirm no favorite was deleted.
  ...
  // define test suite for a signed in member to favorite a post

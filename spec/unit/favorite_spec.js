...
describe("Favorite", () => {
  ...
  beforeEach((done) => {
    ...
    // set the data to clear and then create the objects that will be used in tests.
  ...
  // define the test suite for the create action
  describe("#create()", () => {

    // write a test to check that a favorite is created successfully. 
    it("should create a favorite for a post on a user", (done) => {

      // create a favorite object for `this.post` and `this.user`
      Favorite.create({
        postId: this.post.id,
        userId: this.user.id
      })
        .then((favorite) => {
          ...
          // Ensure that the favorite was created successfully.
    ...
    // Write a test to check that a favorite is not created without a `userId` or `postId`
  ...
  //define the test suite for the `setUser` method.
  describe("#setUser()", () => {
  ...
  // define the test suite for the `getUser` method.
  describe("#getUser()", () => {
  ...
  // define the test suite for the `setPost` method.
  describe("#setPost()", () => {
  ...
  // define test suite for the `getPost` method.
  describe("#getPost()", () => {

// Add all dependencies for the tests.
...
describe("Vote", () => {
  ...
  beforeEach((done) => {
    // Define the variables that will be used throughout the tests.
    this.user;
    this.topic;
    this.post;
    this.vote;

    // Clear the database and create the objects to be used in the tests.
  ...
  describe("#create()", () => {
    ...
    // Write a test to check that an upvote can get created.
    ...
    // Write a test to check that a downvote can be created
